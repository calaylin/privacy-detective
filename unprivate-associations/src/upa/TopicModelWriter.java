...
public class TopicModelWriter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //input file
        String inputFileName = "topic_test/training/topicModel_converted.txt";
        ...
        int numTopics = 100;
        int topWordsNum =25;
        String dataName= "twitter_topicModel_Jan31";

        //generate model path
        String modelPath="model/" + dataName + "_" + Integer.toString(numTopics) +".model";
